...
function Forgot() {
  ...
  return <AuthShell title="Reset your password" subtitle="We'll email you a reset link.">
    {sent ? (
      ...
      <form onSubmit={(e) => { e.preventDefault(); setSent(true); }} className="space-y-4">
        ...
        <p className="text-sm text-center text-muted-foreground"><Link to="/login" className="text-primary hover:underline">Back to sign in</Link></p>
      </form>
    )}
  </AuthShell>;
}
