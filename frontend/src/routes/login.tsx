...
const features = [
  {
    ...
    desc: "Automatically extract and qualify leads from every conversation.",
  },
  {
    icon: Zap,
    title: "Instant 24/7 responses",
    desc: "Reply to enquiries in under 30 seconds, any time of day.",
  },
  {
    icon: BarChart3,
    title: "Full pipeline visibility",
    desc: "Track every lead from first contact to closed deal.",
  },
] as const;
