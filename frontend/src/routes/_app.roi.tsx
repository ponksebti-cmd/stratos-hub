    ...
    <div className="space-y-6">
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          {
            l: t("Avg. cost / lead"),
            v: totals.chats > 0 ? `₹${Math.round((totals.credits * 1.5) / totals.chats)}` : "—",
          },
        ].map((k) => (
          <Card key={k.l}>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {t("Credits consumed and chats handled over the last 7 days.")}
          </CardDescription>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle>{t("Business impact")}</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="grid sm:grid-cols-3 gap-6 text-sm">
            <div>
              ...
              <div className="text-xs text-muted-foreground mt-1">
                {t("~4 min saved per AI-handled chat.")}
              </div>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="text-xs text-muted-foreground mt-1">
                {t("Qualified leads vs. 5% baseline.")}
              </div>
            </div>
          </div>
        </CardContent>
